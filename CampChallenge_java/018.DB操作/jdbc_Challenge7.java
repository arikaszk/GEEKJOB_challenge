    ...
    public static void main (String[] args) throws Exception{
        ...
        ("jdbc:mysql://localhost:8889/Challenge_db", "root", "root");  //rootのパスワードに"root"を設定しています
            ...
            */
            ...
            String upd1 = "UPDATE profiles SET name = ?, tel = ?, age = ?, birthday = ? WHERE profilesID = ?";
            PreparedStatement st = con.prepareStatement(upd1);
            st.setString(1, "山下　清");
            st.setString(2, "03-8888-9999");
            st.setInt(3, 33);
            st.setString(4, "1984-01-01");
            st.setInt(5, 4);
